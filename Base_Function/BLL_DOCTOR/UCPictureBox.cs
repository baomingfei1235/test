        ...
        public void Img(InPatientInfo inpatient)
        {
            ...
            if (inpatient != null)
            {
                ...
                if (inpatient.Id != 0)
                {
                    ...
                    {
                        gh.DrawImage(global::Base_Function.Resource.card_woman, 4, 4, global::Base_Function.Resource.card_woman.Width, global::Base_Function.Resource.card_woman.Height);//, new Point(4, 1));
                    }
                    else
                    {
                        gh.DrawImage(global::Base_Function.Resource.card_man, 4, 4, global::Base_Function.Resource.card_man.Width, global::Base_Function.Resource.card_man.Height);//new Point(4, 1));
                    }
                    ...
                    gh.DrawString(sick_bed_name, new Font("宋体", 14F, FontStyle.Regular,
                                GraphicsUnit.Point, ((byte)(134))), Brushes.Black, new PointF(global::Base_Function.Resource.card_man.Width + 110, 22));//110, 8
