                    ...
                    if (list[i].Describe != null)
                    {
                        if (list[i].Describe.ToString().Contains("手术"))
                        {
                            ...
                            if (list[i].Describe.ToString().Contains("手术"))
                            {
                                ...
                                sql_operation = "insert into v_job_temp(PID,OPERATE_TYPE,OPERATE_TIME,PATIENT_ID,age) values('" + list[i].Pid.ToString() + "','" + operater_type + "',to_timestamp('" + operation_startTime + "','syyyy-mm-dd hh24:mi:ss')," + pids_id + ",'" + strAge + "')";
                                sql_operations = "insert into v_job_temp(PID,OPERATE_TYPE,OPERATE_TIME,PATIENT_ID,age) values('" + list[i].Pid.ToString() + "','" + operater_types + "',to_timestamp('" + operation_endTime + "','syyyy-mm-dd hh24:mi:ss')," + pids_id + ",'" + strAge + "')";
                            }
                        }
                        else
                        {
                ...
                if (isYN)
                {
                    ...
                    for (int t = 0; t < ltime.Count; t++)
                    {
                        if (ltime[t] != "")
                        {
                            ...
                            string sql1 = "insert into v_job_temp(PID,OPERATE_TYPE,OPERATE_TIME,PATIENT_ID,age,EVENT_TYPE) values('" + pid + "','" + operater_type + "',to_timestamp('" + operation_startTime + "','syyyy-mm-dd hh24:mi:ss')," + pids_id + ",'" + strAge + "','-')";

                            string sql2 = "insert into v_job_temp(PID,OPERATE_TYPE,OPERATE_TIME,PATIENT_ID,age,EVENT_TYPE) values('" + pid + "','" + operater_types + "',to_timestamp('" + operation_endTime + "','syyyy-mm-dd hh24:mi:ss')," + pids_id + ",'" + strAge + "','-')";
                    ...
                    if (list[i].Describe != null)
                    {
                        if (list[i].Describe.ToString().Contains("手术"))
                        {
                            ...
                            if (list[i].Describe.ToString().Contains("手术"))
                            {
                                ...
                                {
                                    sql_operation = "insert into v_job_temp(PID,OPERATE_TYPE,OPERATE_TIME,PATIENT_ID,age,EVENT_TYPE) values('" + list[i].Pid.ToString() + "','" + operater_type + "',to_timestamp('" + operation_startTime + "','syyyy-mm-dd hh24:mi:ss')," + pids_id + ",'" + strAge + "','+')";
                                }
                                if (App.ReadSqlVal(sql_del_operations, 0, "c") == "0")
                                {
                                    sql_operations = "insert into v_job_temp(PID,OPERATE_TYPE,OPERATE_TIME,PATIENT_ID,age,EVENT_TYPE) values('" + list[i].Pid.ToString() + "','" + operater_types + "',to_timestamp('" + operation_endTime + "','syyyy-mm-dd hh24:mi:ss')," + pids_id + ",'" + strAge + "','+')";
                                }
                            }
                        }
                        else
